...
def nextgrid(lines,i,g,gc,over):
    j = 0
    m = []
    c = []
    while j<5:
...
i = 2
while i < len(lines):
    nextgrid(lines,i,grids,gridscheck,over)
    i += 6

def bingo(bingonumbers,grids,gridscheck,over,nover):
...
print(bingo(bingonumbers,grids,gridscheck,over,nover))
